...
const TIME_LIMIT_DEFAULT = 2;
const TEAMS_LOCK_DEFAULT = true;
const PASSWORD_DEFAULT = "m";

// Constantes Admin
const ADMIN_PASSWORD_DEFAUT = "CAPF";
const SET_ADMIN_COMMAND_DEFAUT = "!" + ADMIN_PASSWORD_DEFAUT;

// Constantes cores dos times
...
const TeamStatsController = class TeamStatsController 
{
    ...
    printPosseDeBola()
    {
        room.sendAnnouncement("Posse de bola 🔴 " + this[1].posse + "% : " + this[2].posse + "% 🔵", null, PRIMARY_COLOR_DEFAULT, "bold", 0);
    }

    calculaPosse()
    {
        this[1].posse = 100 * this[1].qtdToques / (this[1].qtdToques + this[2].qtdToques);
        this[1].posse = Math.floor(isNaN(this[1].posse) ? 0 : this[1].posse);
        this[2].posse = 100 - this[1].posse;
    }

    onTeamVictory(scores)
    {
        room.sendAnnouncement("🏆 Vitória do time " + ((scores.red > scores.blue) ? "🔴" : "🔵"), null, PRIMARY_COLOR_DEFAULT, "bold", 0);
        this.calculaPosse();
...
const CommandController = class CommandController
{
    ...
    constructor(statsController, teamStatsController) 
    {
        ...
        this.CommandsPermissions = {
            ...
            "!CleanPass"                :   CommandPermission.Create(true,  this.cleanPassword)
        };
        // Comando Default
    ...
    printAdminInfo(player, statsControllerInjection)
    {
        ...
        console.log(statsControllerInjection.AuthToId);
        console.log(statsControllerInjection.stats);
        console.log("---------===================");
    }

    printStat(player, statsControllerInjection)
    {
        statsControllerInjection.printPlayerStat(player.id);
    }
...
const teamStatsController = new TeamStatsController();
